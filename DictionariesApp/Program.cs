...
namespace DictionariesApp
{
    public class DictionaryManager
    {
        ...
        {
            Console.Write("Enter the type of dictionary (e.g., English-Russian): ");
            string type = Console.ReadLine()?.Trim();
            if (type == null)
            {
    ...
    internal class Program
    {
        ...
        {
            Console.Write("Enter dictionary folder name: ");
            DictionaryManager manager = new DictionaryManager(Console.ReadLine());
            manager.Run();
        }
    }
}